...
public class UserService implements CRUDService<UserDto> {
    private final Storage<User> repository;
    ...
    public UserDto create(UserDto userDto) {
        ...
        User user = mapper.makeDtoToEntity(userDto);
        checkUniqueEmail(user.getEmail());

        return mapper.makeEntityToDto(repository.create(user));
    }
    ...
    public UserDto get(Integer id) {
        ...
        return mapper.makeEntityToDto(user);
    }
